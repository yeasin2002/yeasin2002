import classes from "./ProjectNextCard.module.css";

const ProjectNextCard = () => {
  return (
    <div>
      <div className={classes.main}>
        <div className={classes.card}>
          <div className={classes.fl}>
            <div className={classes.fullscreen}>
              <svg viewBox="0 0 100 100" className={classes.fullscreen_svg}>
          ...
          <div className={classes.card_content}>
            <label className={classes.switch_738}>
              <input type="checkbox" className={classes.chk_738} />
              <span className={classes.slider_738}></span>
            </label>
          </div>
        ...
        Z"
          ...
          <div className={classes.text}>
            <div className={classes.text_m}>CSS Theme Switch</div>
            <div className={classes.text_s}>Praashoo7</div>
          </div>
        </div>
        <div className={classes.btns}>
          ...
          <div className={classes.views}>
            <svg className={classes.views_svg} viewBox="0 0 30.5 16.5">
            ...
            <span className={classes.views_text}>332</span>
          </div>
        </div>
      </div>
    </div>
