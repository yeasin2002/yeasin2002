    ...
    <section className="eachSections py-10" id="skill">
      ...
      <div className="grid justify-end flex-col ">
        <p className="flex items-center">
          ...
          <span className="text-gray-300 font-medium">Most comfortable with</span>
        </p>
        <p className="flex items-center">
          <span className="inline-block w-4 h-4 mr-2 rounded-full bg-[#166534]"></span>
          <span className="text-gray-300 font-medium">Comprehensive skill</span>
        </p>
        <p className="flex items-center">
          <span className="inline-block w-4 h-4 mr-2 rounded-full bg-[#FACC15]"></span>
