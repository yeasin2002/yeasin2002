...
const FeedbackCard = ({ content, name, title, img }: feedbackInterface) => (
  <div className="flex justify-between flex-col w-full px-10 py-12 rounded-[20px]   md:mr-10 sm:mr-5 mr-0 my-5 feedback-card">
    ...
    />
    <p className="font-poppins font-normal text-[18px] leading-[32.4px] 2xl:text-2xl text-white my-10">
      {content}
    </p>
    ...
    <div className="flex flex-row">
      ...
      <div className="flex flex-col ml-4">
        <h4 className="font-poppins font-semibold text-[20px] leading-[32px] text-white 2xl:text-4xl">
          {name}
        </h4>
        <p className="font-poppins font-normal text-[16px] leading-[24px] text-dimWhite 2xl:text-2xl">
          {title}
        </p>
      </div>
    </div>
