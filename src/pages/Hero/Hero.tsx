...
import { CalistogaFont, KellySlabFont, PragatiNarrowFont, SubtitleFont } from "@/utils/GoogleFonts";
          ...
          <div className="lg:flex-grow xl:mr-10 2xl:mr-52 md:w-1/2 lg:pr-24 md:items-start md:text-left md:mb-0 flex flex-col items-center flex-1 mb-16 text-center">
            ...
            <div className="flex flex-col items-start">
              <p className=" lg:text-xl text-left   sm:text-2xl  2xl:text-3xl xl:my-7 2xl:my-10 mb-4 text-lg text-blue-200 ">
                <span className={KellySlabFont.className}>Optimistic Learner, Programmer, Open For work</span>
                <br />
              ...
              >
                A self-taught web application developer, Love to build front end and think that how would user interact
                wth the application. want to build Tools for Developer and contribute to open source.
              </p>
            </div>
